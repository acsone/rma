...
class TestRmaMultiStepRoute(TestRmaSaleStockRestockingFeeInvoicingCommon):
    ...
    def test_restocking_fee_invoice_last_step(self):
        """
        Define restocking fees on the RMA operation, RMA operation with
    ...
    def test_restocking_fee_on_so_last_step(self):
        """
        Define restocking fees on the RMA operation, RMA operation with
