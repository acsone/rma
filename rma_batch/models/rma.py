...
class Rma(models.Model):
    ...
    @api.depends("state", "batch_id.operation_id")
    ...
    @api.depends("state", "batch_id.partner_id")
    ...
    @api.depends("state", "batch_id.user_id")
    ...
    @api.depends("state", "batch_id.tag_ids")
    ...
    @api.depends("state", "user_id", "batch_id.team_id")
